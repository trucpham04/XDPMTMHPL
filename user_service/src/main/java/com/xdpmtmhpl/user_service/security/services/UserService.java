...
// user.setPassword(signupRequest.getPassword()); // Lưu mật khẩu dưới dạng
// plain text
...
// jwtUtils.generateRefreshJwtCookie(refreshToken);
...
// String refreshToken =
// jwtUtils.generateRefreshToken(userDetails.getUsername());
